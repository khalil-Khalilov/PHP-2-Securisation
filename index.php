...
<body>
    ...
    <div id="form_container">
        <form action="thanks.php" method="POST">
            ...
            <input type="text" id="users_last-name" name="users_last-name" for="users_last-name" required>

            <label for="users_first-name">Prenom :</label>
            <input type="text" id="users_first-name" name="users_first-name" for="users_first-name" required>

            <label for="users_email">Email :</label>
            <input type="email" id="users_email" name="users_email" for="users_email" placeholder="exemple@gmail.com" required>

            <label for="users_phone">Numéro de téléphone :</label>
            <input type="tel" id="users_phone" name="users_phone" for="users_phone" required>
            ...
            <textarea id="users_message" name="users_message" for="users_message" cols="60" rows="10" required></textarea>
